...
public:
  ...
  void patternStroke(GfxState *state, SplashPath *orgPath);
  void patternFillChar(GfxState *state,
        double x, double y, CharCode code);
  GfxPath *splashPathToGfxPath(SplashPath *path);
  GfxPath *bitmapToGfxPath(SplashBitmap *bitmapA, int width, int height);
